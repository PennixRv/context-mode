...
/**
 * Kiro's default matcher deliberately excludes external MCP tools. The shared
 * router remains defensive for direct callers, but the normal hook path must
 * not start context-mode for an unknown MCP namespace.
 */
// ─────────────────────────────────────────────────────────
// PreToolUse matchers
// ─────────────────────────────────────────────────────────
